      ...
      <section className="relative h-full container text-black mx-auto rounded-lg py-14 bg-white" ref={testimonialRef}>
        ...
        <div className="lg:grid lg:grid-cols-3 gap-2 flex flex-col w-full lg:py-10 pt-10 pb-4 lg:px-10 px-4">
          <div className="md:flex lg:flex-col lg:space-y-2 h-full lg:gap-0 gap-2">
            <TimelineContent animationNum={0} customVariants={revealVariants} timelineRef={testimonialRef} className="lg:flex-[7] flex-[6] flex flex-col justify-between relative bg-sky-600 text-white overflow-hidden rounded-lg border border-gray-200 p-5">
              ...
              <article className="mt-auto relative z-10">
                ...
                <div className="flex justify-between pt-5">
                  <div>
                    ...
                    <p className="text-sky-100 text-xs sm:text-sm">CEO of Enigma</p>
                  </div>
                  <img
            ...
            <TimelineContent animationNum={1} customVariants={revealVariants} timelineRef={testimonialRef} className="lg:flex-[3] flex-[4] lg:h-fit lg:shrink-0 flex flex-col justify-between relative bg-sky-500 text-white overflow-hidden rounded-lg border border-gray-200 p-5">
              <article className="mt-auto">
                ...
                <div className="flex justify-between pt-5">
                  <div>
                    ...
                    <p className="text-sky-100 text-xs sm:text-sm">CEO of Kintsugi</p>
                  </div>
                  <img
          ...
          <div className="lg:h-full md:flex lg:flex-col h-fit lg:space-y-2 lg:gap-0 gap-2">
            <TimelineContent animationNum={2} customVariants={revealVariants} timelineRef={testimonialRef} className="flex flex-col justify-between relative bg-[#111111] text-white overflow-hidden rounded-lg border border-gray-800 p-5">
              <article className="mt-auto">
                ...
                <div className="flex justify-between items-end pt-5">
                  <div>
                    ...
                    <p className="lg:text-base text-sm text-gray-400">CEO of OdeaoLabs</p>
                  </div>
                  <img
            ...
            <TimelineContent animationNum={3} customVariants={revealVariants} timelineRef={testimonialRef} className="flex flex-col justify-between relative bg-[#111111] text-white overflow-hidden rounded-lg border border-gray-800 p-5">
              <article className="mt-auto">
                <p className="2xl:text-base text-sm">
                ...
                <div className="flex justify-between items-end pt-5">
                  <div>
                    ...
                    <p className="lg:text-base text-sm text-gray-400">CEO of Labsbo</p>
                  </div>
                  <img
            ...
            <TimelineContent animationNum={4} customVariants={revealVariants} timelineRef={testimonialRef} className="flex flex-col justify-between relative bg-[#111111] text-white overflow-hidden rounded-lg border border-gray-800 p-5">
              <article className="mt-auto">
                <p className="2xl:text-base text-sm">
                ...
                <div className="flex justify-between items-end pt-5">
                  <div>
                    ...
                    <p className="lg:text-base text-sm text-gray-400">CEO of boxefi</p>
                  </div>
                  <img
          ...
          <div className="h-full md:flex lg:flex-col lg:space-y-2 lg:gap-0 gap-2">
            <TimelineContent animationNum={5} customVariants={revealVariants} timelineRef={testimonialRef} className="lg:flex-[3] flex-[4] flex flex-col justify-between relative bg-sky-500 text-white overflow-hidden rounded-lg border border-gray-200 p-5">
              <article className="mt-auto">
                <p>
                ...
                <div className="flex justify-between pt-5">
                  <div>
                    ...
                    <p className="text-sky-100 text-xs sm:text-sm">CEO of OdeaoLabs</p>
                  </div>
                  <img
            ...
            <TimelineContent animationNum={6} customVariants={revealVariants} timelineRef={testimonialRef} className="lg:flex-[7] flex-[6] flex flex-col justify-between relative bg-sky-600 text-white overflow-hidden rounded-lg border border-gray-200 p-5">
              <div className="absolute bottom-0 left-0 right-0 top-0 bg-[linear-gradient(to_right,#ffffff2e_1px,transparent_1px),linear-gradient(to_bottom,#ffffff2e_1px,transparent_1px)] bg-[size:50px_56px] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_0%,#000_70%,transparent_110%)]"></div>
              <article className="mt-auto relative z-10">
                <p>
                ...
                <div className="flex justify-between pt-5">
                  <div>
                    ...
                    <p className="text-sky-100 text-xs sm:text-sm">CTO of Spectrum</p>
                  </div>
                  <img
